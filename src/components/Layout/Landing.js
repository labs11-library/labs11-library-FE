                ...
                <div className="container">
                    ...
                    <div className="col-12 col-md-8 col-lg-7 col-md-5 text-center">
                        ...
                        <div className="row">
                            ...
                            <a href={`${backendBaseUrl}/auth/google`} style={{margin:"0 auto"}}>
                        ...
                        <div className="row mt-4">
                            <div className="col">
                            <a href={`${backendBaseUrl}/auth/facebook`} style={{margin:"0 auto"}}>
                                <button class="loginBtn loginBtn--facebook">
                                    Signup with Facebook
                                </button>
                            </a>
                            <p><a href="https://bookmaps.netlify.com/login">Already have an account?</a></p>
                            </div>
                        </div>
                        </div>
                    </div>
